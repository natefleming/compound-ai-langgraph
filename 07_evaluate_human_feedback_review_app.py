...
# MAGIC %md # Run an evaluation on human feedback output logs

# COMMAND ----------

# MAGIC %pip install -U databricks-agents mlflow databricks-sdk
...
# MAGIC %md ## Remove duplicate entries from the assessment log
...
# MAGIC %md ## Get the ground truth responses
